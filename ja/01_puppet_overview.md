...
参考までに、zshのパッケージをインストールするための記述を、PuppetとChefと併記して掲載します。
...
たいして違いません。Puppetは外部DSLを採用しているため、あらたにそれを習得しなければならないのは事実です。しかし、仕様の隅々まで知るとなれば話は別ですが、実際によく使う程度の記法は、本書を読み進めていくうちに自然と憶えてしまうでしょう。
